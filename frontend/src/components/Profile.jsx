      ...
      <div className="w-[50%] border-l border-r border-gray-200">
        <div>
          <div className="flex items-center py-2">
            ...
            <div className="ml-2">
              <h1 className="font-bold text-lg">Manu</h1>
          ...
          <div className="m-4">
            <h1 className="font-bold text-xl">Manu</h1>
            <p>@mern stack</p>
          </div>
          <div className="m-4 text-sm">
            <p>
              🌐 Exploring the web's endless possibilities with MERN Stack 🚀 |
              Problem solver by day, coder by night 🌙 | Coffee lover ☕ | Join
              me on this coding journey!
            </p>
          </div>
        </div>
      </div>
